...
1. Download navicat from official website.
   ...
   I assume that the AppImage file is in `~/Downloads` folder.

2. Extract all files in the AppImage to a directory. For example:

   ```console
   $ mkdir ~/Downloads/navicat15-premium-en
   $ sudo mount -o loop ~/Downloads/navicat15-premium-en.AppImage ~/Downloads/navicat15-premium-en
   $ cp -r ~/Downloads/navicat15-premium-en ~/Downloads/navicat15-premium-en-patched
   $ sudo umount ~/Downloads/navicat15-premium-en
   $ rm -rf ~/Downloads/navicat15-premium-en
   ```
...
4. Use `navicat-patcher` to replace the official public key.
   ...
   ```console
   $ ./bin/navicat-patcher ~/Downloads/navicat15-premium-en-patched
   ```
   ...
   ```console
   **********************************************************
   *       Navicat Patcher (Linux) by @Euris Lee            *
   *                  Version: 1.0                          *
   **********************************************************
   ...
   *******************************************************
   ...
   [*] New RSA-2048 private key has been saved to
      /home/eurislee/github.com/navicat-keygen/RegPrivateKey.pem
...
5. Repack files into a new AppImage:
   ...
   $ ./appimagetool-x86_64.AppImage ~/Downloads/navicat15-premium-en-patched ~/Downloads/navicat15-premium-en-patched.AppImage
   ```

6. Run the newly-generated AppImage:

   ```console
   $ chmod +x ~/Downloads/navicat15-premium-en-patched.AppImage
   $ ~/Downloads/navicat15-premium-en-patched.AppImage
   ```
...
7. Use `navicat-keygen` to generate __snKey__ and __Activation Code__.
   ...
   $ ./bin/navicat-keygen --text ./RegPrivateKey.pem
   **********************************************************
   *       Navicat Keygen (Linux) by @Euris Lee             *
   *                   Version: 1.0                         *
   **********************************************************
...
10. Copy your request code and paste it in the keygen. Input empty line to tell the keygen that your input ends.
    ...
    [*] Response Info:
    {"K":"NAVMRTVJEO42IODD","DI":"4A12F84C6A088104D23E","N":"Euris Lee","O":"Euris Lee","T":1575543648}
...
12. Clean up:
    ...
    ```console
    $ rm ~/Downloads/navicat15-premium-en.AppImage
    $ rm -rf ~/Downloads/navicat15-premium-en-patched
    $ mv ~/Downloads/navicat15-premium-en-patched.AppImage ~/Downloads/navicat15-premium-en.AppImage
    ```
